...
# from visualizer_3d import visualize_landmarks_3d
#
# # Static view of a specific frame
# visualize_landmarks_3d("output/video_hello/video_landmarks.json", mode='static', frame_number=0)
#
# # Animated view of all frames
# visualize_landmarks_3d("output/video_hello/video_landmarks.json", mode='animated')
#
# # Save animation as GIF
# visualize_landmarks_3d("output/video_hello/video_landmarks.json", mode='animated', save_path="animation.gif")

#TODO does it work with frames??
#TODO why is pose so janky
#TODO better face mesh visualization
